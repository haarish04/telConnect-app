            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <p className="why-us-text">
                  At TelConnect, we go beyond being just a telecom provider—we
                  are the heartbeat of global communication. With over 100
                  million happy customers in more than 200 countries, our
                  network bridges borders, cultures, and time zones
                  effortlessly.
                  <br />
                  <br />
            ...
            <div className="row align-items-center mt-5">
              ...
              <div className="col-md-6">
                <p className="why-us-text">
                  ...
                  positioned us as a leader in the telecom industry. Every day,
                  we enable over a billion interactions—whether it’s a quick
                  chat with a friend, a vital business call, or a heartfelt
                  video message. We are the trusted choice for millions who seek
