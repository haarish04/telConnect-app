...
describe('EditServicePlans Component', () => {
  const plans = [
    { planId: 'PREP001', planName: 'Prepaid Plan 1', planDescription: 'Description 1', planPrice: 'Rs. 100', planDuration: '30 Days' },
    { planId: 'POST001', planName: 'Postpaid Plan 1', planDescription: 'Description 2', planPrice: 'Rs. 200', planDuration: '30 Days' },
  ];
  ...
  test('updates plan details', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/plan name/i), { target: { value: 'Updated Prepaid Plan' } });
    fireEvent.change(screen.getByLabelText(/price/i), { target: { value: 'Rs. 150' } });
    fireEvent.change(screen.getByLabelText(/duration/i), { target: { value: '60 Days' } });
    ...
    await waitFor(() => {
      expect(axios.patch).toHaveBeenCalledWith(
        expect.stringContaining('${process.env.REACT_APP_API_BASE_URL}/admin/PREP001/edit'),
