...
import ErrorPage from '../components/ErrorPage'; // Ensure this path is correct
...
describe('ErrorPage Component', () => {
  test('renders the error page with correct content', () => {
    ...
    const descriptionElement = screen.getByText(/Looks like the page you are trying to find does not exist/i);
